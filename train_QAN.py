...
def parse_args():
	...
	parser.add_argument('--model_prefix', help='model prefix to save model', default='model', type=str)
...
if __name__ == '__main__':
	...
	fileiter = dataiter_custom.FileIter(data_shapes=data_shapes, set_num=args.set_num, ctx=ctx[0],
